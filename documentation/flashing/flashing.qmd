...
<script>
  ...
  const options = {
    yulc: [
      { value: 'WLED_0.15.0-b5_AR_MR', text: 'WLED 0.15.0-b5_AR_MR_IT' },
...
<p class="button-row" align="center">
 ...
 <!-- Script per scegliere manifest-->
<script>
  document.querySelectorAll('input[name="type"]').forEach(radio =>
    radio.addEventListener("change", () => {

      let element = document.getElementById("software");
      element.removeAttribute("hidden");

      const button = document.querySelector('esp-web-install-button');
      button.manifest = `../../Software/manifest_${radio.value}_${element.value}.json`;
